...
first_name = (data['meals'][0]['strMeal'])
second_name = (data['meals'][1]['strMeal'])
third_name = (data['meals'][2]['strMeal'])
fourth_name = (data['meals'][3]['strMeal'])

print(first_name,second_name,third_name,fourth_name, sep = '\n')