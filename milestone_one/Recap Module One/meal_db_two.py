...
print(meal.keys())
first_meal_data = meal['meals'][0]['strMeal']
second_meal_data = meal['meals'][1]['strMeal']
third_meal_data = meal['meals'][2]['strMeal']
fourth_meal_data = meal['meals'][3]['strMeal']
print('First meal is:', first_meal_data, 'Second meal is:', second_meal_data, 'Third meal is:', third_meal_data, 'Fourth meal is:', fourth_meal_data, sep='\n')
